...
#Exchange rates data is a STUB for the below URL- exchange rates was created in same format so when we switch it out for real data the tests still all pass.
  before(:each) do
